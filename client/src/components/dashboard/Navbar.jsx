const Navbar = () => {
  return (
    <nav className="bg-[#FEFEFE] w-full flex justify-around items-center py-4 px-4 shadow-sm">
      ...
      <ul className="flex space-x-6">
        ...
        <li className="text-[#585D67] hover:text-[#101726] cursor-pointer">Responses</li>
      </ul>

      <div className="flex items-center space-x-4">
        <button className="border px-4 py-2 bg-[#101726] rounded-lg text-white hover:bg-[#1c2a43] transition-colors">
          Create a Question
        </button>
