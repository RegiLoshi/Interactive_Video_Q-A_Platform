...
const Hero = () => {
    return (
        <div className="flex flex-col justify-center items-center space-y-4 bg-[#F9F9FB] py-8 min-h-[30vw]">
            ...
            <div>
                <button className="flex items-center justify-around space-x-5 w-full border px-4 py-2 bg-[#101726] rounded-lg text-white hover:bg-[#1c2a43] transition-colors  cursor-pointer">
